...
echo "Downloading Kingdom Hearts Re:Fined 4.00 by TopazTK"
...
mv "KH2.exe" "${khInstall}/KINGDOM HEARTS II FINAL MIX.exe"
...
read -p "Will you be running Kingdom Hearts with Proton/Proton-GE, or Wine/Wine-GE? (proton/wine/skip) " ProCon
...
WINEPREFIX=~/RefinedPrefix wine KHPCPatchManager.exe ReFinedBETA-SteamOS.kh2pcpatch "${khInstall}/Image/en"
#WINEPREFIX=~/RefinedPrefix wine KHPCPatchManager.exe KH2DAPatch.kh2pcpatch "${khInstall}/Image/en"
#WINEPREFIX=~/RefinedPrefix wine KHPCPatchManager.exe BBSDAPatch.BBSpcpatch "${khInstall}/Image/en"
